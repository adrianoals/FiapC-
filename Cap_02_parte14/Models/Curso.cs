using Cap_02_parte14.Exceptions;
using System;
...
namespace Cap_02_parte14.Models
{
    internal class Curso
    {
        ...
        public void CriarAluno(string nome)
        {
            ...
            {
                throw new PersonalizadaException("Personalizada - Não é possível cadastrar um aluno sem nome.");
            }
        }
